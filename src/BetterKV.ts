export declare type BetterKVGetReturns<V = unknown> = string | V | ArrayBuffer | ReadableStream;
...
export class BetterKV {
	...
	*/
	...
	async get<V = unknown>(key: string, options: BetterKVTypedGetOptions<"json">): Promise<V | null>;
	 ...
	 * ```
	 */
	async get<V = unknown>(key: string, options?: BetterKVGetOptions): Promise<BetterKVGetReturns | null> {
		const cacheKey = this.url + key;
		const cacheTTL = normalizeCacheTtl(options.cacheTtl);
	...
	async getWithMetadata<M = unknown>(key: string, options: BetterKVGetOptions): Promise<BetterKVWithMetadata<string, M> | null>;
	async getWithMetadata<M = unknown>(key: string, options: BetterKVTypedGetOptions<"text">): Promise<BetterKVWithMetadata<string, M> | null>;
	async getWithMetadata<M = unknown>(key: string, options: BetterKVTypedGetOptions<"arrayBuffer">): Promise<BetterKVWithMetadata<ArrayBuffer, M> | null>;
	async getWithMetadata<M = unknown>(key: string, options: BetterKVTypedGetOptions<"stream">): Promise<BetterKVWithMetadata<ReadableStream, M> | null>;
	async getWithMetadata<V = unknown, M = unknown>(key: string, options: BetterKVTypedGetOptions<"json">): Promise<BetterKVWithMetadata<V, M> | null>;
	...
	*/
	async getWithMetadata<V = unknown, M = unknown>(key: string, options?: BetterKVGetOptions): Promise<BetterKVWithMetadata<BetterKVGetReturns, M> | null> {
		const cacheKey = this.url + key;
		const cacheTTL = normalizeCacheTtl(options.cacheTtl);
		const type = options.type || "text";
		let bodyVal = await this.cache.match(cacheKey);;
	 ...
	 * ```
	 */
	async put<M = unknown>(key: string, val: BetterKVValueOptions, options: BetterKVPutOptions<M>): Promise<void> {
		const cacheKey = this.url + key;
	 ...
	 * ```
	 */
	async list<M = unknown>(opts?: BetterKVListOptions): Promise<KVNamespaceListResult<M>> {
		let { cacheTtl, prefix, limit, cursor } = opts;
		let cacheKey = new URL("https://list.better.kv");
		cacheTtl = normalizeCacheTtl(cacheTtl);
